...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/aws-crt-cpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws-crt-cpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add aws-crt-cpp
# for installing globally
pixi global install aws-crt-cpp
```
...
It is possible to list all of the versions of `aws-crt-cpp` available on your platform:
...
```
pixi search aws-crt-cpp --channel conda-forge
```
